...
private:
    ...
    void AddMateriallyMembraneStiffness(MatrixType& LeftHandSideMatrix, const Matrix& TanC, const Matrix& Bm, int PointNumber);
    void AddGeometricallyMembraneStiffness( MatrixType& LeftHandSideMatrix,const Vector& nVector, const Matrix& DN_De);
    void AddMateriallyBendingStiffness(MatrixType& LeftHandSideMatrix, const Matrix& TanC, const Matrix& Bb, int PointNumber);
    void AddGeometricallyBendingStiffness( MatrixType& LeftHandSideMatrix,const Vector& moVector, const Matrix& DN_De);

    ////////////////////// add right hand side contribution
    void AddExternalLoad(VectorType& RightHandSideVector, const Vector& N, double DetJ, double Weight );


    void AddInternalForcesToRHS(
    ...
    void CovariantBaseVector(std::vector<Vector>& A, const Matrix& DN_De, const std::vector<Vector> X, int PointNumber);
    ...
    void DerivativeNormalDirector(Vector& a3Vector_r, const Vector& aa3_r, const Matrix& a3_r
                                                , const Vector& aa3, const double& a3);
    ...
    void SecondDerivativeNumeratorNormalDirectorUrs(std::vector<Matrix>& aa3_rs, const Matrix& DN_De, std::vector<Vector> e);

    void SecondDerivativeDenominatorNormalDirectorUrs(double& a3_rs,  Vector& aa3Vector_rs,  Vector& aa3Vector
                                                        ,  Vector aa3Vector_r );
    ...
    void CalculateBendingBOperator(
        ...
        void CalculateMembraneBOperator(
            Matrix& Bm,
            const array_1d<double,3>& G1,
            const array_1d<double,3>& G2,
            const Matrix& DN_De);
